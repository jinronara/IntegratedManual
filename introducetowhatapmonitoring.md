...
### 서비스 모니터링 <a id="user-content-&#xC11C;&#xBE44;&#xC2A4;-&#xBAA8;&#xB2C8;&#xD130;&#xB9C1;"></a>

![](.gitbook/assets/saas.png)

### 구축형 모니터링 <a id="user-content-&#xAD6C;&#xCD95;&#xD615;-&#xBAA8;&#xB2C8;&#xD130;&#xB9C1;"></a>

![](.gitbook/assets/onpremise%20%281%29.png)

### 성능 컨설팅 <a id="user-content-&#xC131;&#xB2A5;-&#xCEE8;&#xC124;&#xD305;"></a>

![](.gitbook/assets/counsulting%20%281%29.png)

## 제품 개요 <a id="user-content-&#xC81C;&#xD488;-&#xAC1C;&#xC694;"></a>
...
### 통합 모니터링 구성 <a id="user-content-&#xD1B5;&#xD569;-&#xBAA8;&#xB2C8;&#xD130;&#xB9C1;-&#xAD6C;&#xC131;"></a>

![](.gitbook/assets/2018-09-18-11.25.38.png)

### 서비스 생명주기에 따른 모니터링 <a id="user-content-&#xC11C;&#xBE44;&#xC2A4;-&#xC0DD;&#xBA85;&#xC8FC;&#xAE30;&#xC5D0;-&#xB530;&#xB978;-&#xBAA8;&#xB2C8;&#xD130;&#xB9C1;"></a>
...
## 지원 플랫폼 <a id="user-content-&#xC9C0;&#xC6D0;-&#xD50C;&#xB7AB;&#xD3FC;"></a>
...
### 대규모 모니터링을 위한 파일DB <a id="user-content-&#xD074;&#xB77C;&#xC6B0;&#xB4DC;-&#xD658;&#xACBD;&#xC744;-&#xACE0;&#xB824;&#xD55C;-&#xD655;&#xC7A5;&#xAD6C;&#xC870;"></a>
...
### Scalable & Stable 수집서버 아키텍처 <a id="user-content-&#xD074;&#xB77C;&#xC6B0;&#xB4DC;-&#xD658;&#xACBD;&#xC744;-&#xACE0;&#xB824;&#xD55C;-&#xD655;&#xC7A5;&#xAD6C;&#xC870;"></a>
...
### 멀티 리전 지원 <a id="user-content-&#xBA40;&#xD2F0;-&#xB9AC;&#xC804;-&#xC9C0;&#xC6D0;"></a>
...
### 멀티 테넌트 지원 <a id="user-content-&#xBA40;&#xD2F0;-&#xD14C;&#xB10C;&#xD2B8;-&#xC9C0;&#xC6D0;"></a>
...
### 모니터링 대상 통합관리 <a id="user-content-&#xD655;&#xC7A5;-&#xAC00;&#xB2A5;&#xD615;-&#xAD6C;&#xC870;"></a>
...
### 데이터 암호화 <a id="user-content-&#xB370;&#xC774;&#xD130;-&#xC720;&#xC2E4;-&#xBC29;&#xC9C0;"></a>
...
## 주요 고객 <a id="user-content-&#xC8FC;&#xC694;-&#xACE0;&#xAC1D;"></a>
...
### 인프라 모니터링 <a id="user-content-&#xC778;&#xD504;&#xB77C;-&#xBAA8;&#xB2C8;&#xD130;&#xB9C1;-1"></a>

#### 주요기능 목록

{% tabs %}
{% tab title="클라우드 서버 성능 관리" %}
5초간격 데이터 수집  
모든 프로세스 감시  
커스텀 지수 수집  
클라우드 취약 지수 집중 수집\(IOPS, CPU Steal\)
{% endtab %}

{% tab title="클라우드 플랫폼 지원" %}
국내외 모든 플랫폼 지원  
Auto Scale시 자동 등록 및 해지  
Serverless 서비스 모니터링   
Container 지원\(Docker\)
{% endtab %}
...
#### 특징
 ...
 Whatap Infrastructure Monitoring 은 실무자 관점으로 빠르게 적용하고 쉽게 모니터링 가능한 서버 모니터링 제품입니다. 

![&#xD2B9;&#xC9D5;](.gitbook/assets/2018-09-19-3.10.56.png)

#### 대시보드

운영중인 시스템의 전체 규모 및 전체 자원 상황을 한눈에 확인 가능합니다.

![&#xB9AC;&#xC18C;&#xC2A4; &#xBCF4;&#xB4DC;](.gitbook/assets/2018-09-19-3.16.26.png)

대규모 서버 자원에 대해 샘플링, 요약된 결과가 아닌 전체 모니터링 대상을 시각화 한 화면을 제공합니다.

![&#xCEF4;&#xD30C;&#xC6B4;&#xB4DC; &#xC544;&#xC774;](.gitbook/assets/2018-09-19-3.19.47.png)

전체 관리대상 및 수집항목에 대하여 서버들의 성능 현황을 한눈에 확인이 가능하고, 특정 서버를 선택하여 비교하는 기능을 제공합니다. 운영자가 필요한 지표를 설정할 수 있어 상황에 맞게 복합적으로 현황을 분석할 수 있습니다.

![&#xC11C;&#xBC84; &#xB9AC;&#xC2A4;&#xD2B8; &#xBDF0;](.gitbook/assets/2018-09-19-3.21.16.png)

클라우드와 물리서버를 혼용하는 인프라 구축 환경에서 문제를 자주 일으키는 서버를 한눈에 확인할 수 있습니다.  
특정 에이전트와 수집 서버 간의 통신 상황이 아닌 에이전트 간의 상호 감시를 통해 향상된 정확도의 데이터를 근거 데이터로 활용합니다.  
1일, 1주, 1개월 기준으로 모든 서버의 가용성을 확인할 수 있습니다.

![&#xAC00;&#xC6A9;&#xC131; &#xB300;&#xC2DC;&#xBCF4;&#xB4DC;](.gitbook/assets/avail.png)

#### 성능추이 분석

특정 서버를 선택하며 지표별 시계열 추이를 기간별\(분/시간/일/주/월\)로 확인 할 수 있습니다.

![&#xAE30;&#xAC04;&#xBCC4; &#xCD94;&#xC774; &#xADF8;&#xB798;&#xD504;](.gitbook/assets/2018-09-19-3.27.05.png)

#### OS 자원 및 프로세스 성능 분석

특정 서버의 자원 문제가 식별된 경우, 프로세스 레벨의 자원 상황까지 원인 분석이 가능합니다.  
20초 단위로 수집된 프로세스 정보를 통해, 서버 자원의 문제를 발생시킨 프로세스를 특정 할 수 있습니다.

![&#xC790;&#xC6D0; &#xBC0F; &#xD504;&#xB85C;&#xC138;&#xC2A4; &#xBAA8;&#xB2C8;&#xD130;&#xB9C1;](.gitbook/assets/2018-09-19-3.29.45.png)

####  확장팩 모니터링

3rd Party 스크립트를 직접 등록하여 데이터를 저장하고 임계치 지정을 통한 알림을 받을 수 있습니다. 

![&#xD655;&#xC7A5;&#xD329; &#xBAA8;&#xB2C8;&#xD130;&#xB9C1;](.gitbook/assets/2018-09-19-3.55.13.png)

#### 알림 발행 채널

장애 유형 별 이벤트 알림\(단문메세지, 이메일, 모바일 앱 푸쉬, 대시보드 이벤트 목록\) 기능을 통해 장애 발생 내역을 공유합니다.

![&#xC54C;&#xB9BC; &#xBC1C;&#xD589; &#xCC44;&#xB110;](.gitbook/assets/2018-09-19-3.57.39.png)

### 데이터베이스 모니터링 <a id="user-content-&#xB370;&#xC774;&#xD130;&#xBCA0;&#xC774;&#xC2A4;-&#xBAA8;&#xB2C8;&#xD130;&#xB9C1;"></a>
