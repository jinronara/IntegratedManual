...
[http://repo.whatap.io/debian/unstable/whatap-infra\_{x}.{x}.{x}\_amd64.deb](http://repo.whatap.io/debian/unstable/whatap-infra_{x}.{x}.{x}_amd64.deb)

[http://repo.whatap.io/debian/unstable/whatap-infra\_{x}.{x}.{x}\_i386.deb](http://repo.whatap.io/debian/unstable/whatap-infra_{x}.{x}.{x}_i386.deb)
